...
function test_sync_realm_settings() {
    ...
    {
        /*
            Test that when create stream policy is set to "waiting period" that the dropdown
        ...
        */
        ...
        assert.equal($("#id_realm_create_stream_policy").val(), "by_waiting_period");
    }
    ...
    {
        /*
            Test that when invite to stream policy is set to "waiting period" that the dropdown
            is set to the correct value.
        */
        ...
        assert.equal($("#id_realm_invite_to_stream_policy").val(), "by_waiting_period");
    }
