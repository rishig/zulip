...
function finale(skip) {
    ...
    if (page_params.prompt_for_invites) {
        ...
        alert_contents = "<i class='icon-vector-desktop alert-icon'></i>What's better than " + page_params.product_name + " in your browser? The <a href='{{ server_uri }}/apps' target='_blank'>"+ page_params.product_name + " desktop app</a>!";
    }
